...
const MODULE = [
  ...
  { datei:'el_poe',            praefix:'po', icon:'🌐',
    titel:'PoE — Leistung & RP-Kategorie', kurz:'PoE',
    norm:'IEEE 802.3bt / EN 50174-2',
    sub:'Leistung am Endgerät, DC-Spannungsfall auf der Datenleitung und Bündel-Kategorie' },
