...
try {
  ...
  console.log('— Boot —');
  {
    ...
    /* Die Kennwerte sind eine Gruppe INNERHALB der Berechnungs-Karte und
       bringen KEINE eigene Karte mit — das ist die Aussage dieser Prüfung.
       Die fünfte Karte ist die Selektivität, die separat dazugekommen ist. */
    t('Kennwerte bringen keine eigene Karte mit', await page.locator('.el-card').count() === 5);
