...
(function(w) {
  ...
  var FILE_MAP = {
    ...
    'sb_druckerhoehung':'druckerhoehung','sb_zirkulation':'zirkulation','sb_druckanstieg':'druckanstieg','sb_saugpumpe':'saugpumpe','sb_fluessiggas':'fluessiggas','sb_druckverlust_erdgas':'druckverlust_erdgas','sb_druckverlust_medizinalgas':'druckverlust_medizinalgas','sa_osmose':'osmose',
  ...
  var DEFAULT_ROLES = [
    ...
    {id:'role_magaziner',name:'Magaziner',color:'#ea580c',permissions:(function(){var p=_somePerms(['werkzeugmanagement','fahrzeugmanagement','inspektion_wartung'],true,true,true);p['goodel']={read:true,write:true,admin:false};p['trocknungsgeraete']={read:true,write:true,admin:true};p['einsatzplan']={read:true,write:true,admin:false};p['spuelmanager']={read:true,write:true,admin:false};p['service']={read:true,write:true,admin:false};p['stundenerfassung']={read:true,write:true,admin:false};p['arbeitskleider']={read:true,write:true,admin:true};return p;})()},
    ...
    {id:'role_bauherrschaft',name:'Bauherrschaft',color:'#0284c7',permissions:(function(){var p=_somePerms(['objekte','terminplan','kostenkontrolle','besprechungsprotokoll','abnahme_sia'],true,false,false);p['goodel']={read:true,write:true,admin:false};p['regierapport']={read:true,write:true,admin:false};p['revisionsunterlagen']={read:true,write:false,admin:false};return p;})()},
