...
Wenig Klicks statt vieler Buttons (`scripts/erp_kontextmenu_test.mjs` 39 Checks): `erpCtxShow(e,items)` baut `#erpCtxMenu` (position:fixed, z-index 2000, Viewport-geklemmt; schliesst bei Klick/Escape/Scroll/Resize). Zwei Anwender:
