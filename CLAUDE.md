...
- **Art der Abnahme wählbar** (`state.abnahme.protokollArt`: '' [Werkprüfung/Werksabnahme] | sichtkontrolle | teilabnahme | schlussabnahme — Select im Protokollkopf, Titel `#protoArtTitle` + PDF-Titel folgen der Wahl).
